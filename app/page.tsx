            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <p className="italic text-white text-sm">
                  ...
                  <a href="https://www.eak.ventures/" target="_blank" rel="noopener noreferrer" className="!text-white hover:underline hover:!text-white">EAK Ventures</a> and{" "}
                  <a href="https://coinswitch.co/ventures" target="_blank" rel="noopener noreferrer" className="!text-white hover:underline hover:!text-white">Coinswitch Venture</a>
                </p>
