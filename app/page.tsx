    ...
    <main className="flex-1">
      ...
      <div className="md:hidden w-full min-h-screen pt-4 px-4 pb-1 py-8 relative overflow-hidden">
        ...
        <div className="relative w-[90%] mx-auto h-[600px] overflow-visible z-10  ">
          ...
          <div className="absolute left-[10%] bottom-[22px] translate-y-1/2 w-[110%] max-w-[95vw] max-h-[420px] bg-black text-white shadow-xl flex flex-col justify-center p-7 z-20 overflow-y-auto break-words whitespace-normal">
      ...
      <div className="md:hidden flex justify-center space-x-6 z-30 absolute bottom-2 left-0 right-0">
        <a
      ...
      <div className="hidden md:block relative w-full h-screen items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/2 left-0 -translate-y-1/2 z-20 w-[420px] h-[480px] flex flex-col items-center justify-center">
          <div className="bg-black text-white shadow-xl w-full h-full flex flex-col justify-center p-8">
            <h1 className="text-2xl md:text-3xl leading-tight mb-6 mt-8 text-white">
              Shabbir Khan
            </h1>
            ...
            <div className="text-white text-sm flex items-center space-x-2 hover:text-gray-300 mb-6">
              <MapPin className="w-4 h-4" />
              <span className="text-white">Dubai, UAE</span>
            </div>
