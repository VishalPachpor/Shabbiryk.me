            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <p className="italic text-gray-300 text-xs">
                  <a href="https://www.yusufalthani.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Private Office</a>,{" "}
                  <a href="https://bluegreen.vc" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Blugreen Venture</a>,{" "}
                  <a href="https://www.statestreet.com/us/en/solutions/digital-assets" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">State Street</a>,{" "}
                  <a href="https://www.eak.ventures/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">EAK Ventures</a> and{" "}
                  <a href="https://coinswitch.co/ventures" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Coinswitch Venture</a>
                </p>
